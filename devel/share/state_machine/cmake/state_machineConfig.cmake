...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/cody/Documents/code/robosub/Final_Build/src/Global_Control/state_machine)
  set(state_machine_DEVEL_PREFIX /home/cody/Documents/code/robosub/Final_Build/devel)
  ...
  set(state_machine_INSTALL_PREFIX /home/cody/Documents/code/robosub/Final_Build/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'cody <cody@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cody/Documents/code/robosub/Final_Build/src/Global_Control/state_machine/${idir}'.  Ask the maintainer 'cody <cody@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cody/Documents/code/robosub/Final_Build/devel/lib;/home/cody/Dropbox/advanced_robotics/coco3090/Homework3/devel/lib;/opt/ros/kinetic/lib)
